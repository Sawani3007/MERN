...
newHead.innerText = "Some authentic Recipies";
const mainRoot = document.getElementById("root");
mainRoot.append(newHead);
mainRoot.append(newList);
for(let elem of recipe.recipes){
  const lelem = document.createElement("li");
  lelem.innerHTML =  `${elem.name} <del>${elem.cuisine}</del> `;
  newList.append(lelem);
